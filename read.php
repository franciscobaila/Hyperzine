...
<body>
  ...
  <nav id="read-nav">
    <img class="read-nav-a" width="30px" src="http://iconmonstr.com/g/gd/makefg.php?i=s2/default/iconmonstr-book-5-icon.png&r=255&g=255&b=255"/><br><br><br>
    <img class="read-nav-a"  width="30px" src="http://iconmonstr.com/g/gd/makefg.php?i=s2/default/iconmonstr-quote-13-icon.png&r=255&g=255&b=255"/><br><br><br>
  ...
  <div id="popInst" class="open">
    ...
    <p><b>Have fun!</b></p>
      ...
      <!-- Texto do Livro -->
      <div id="read-text" class="editavel">
...
-->
    ...
    function editableTextBlurred() {
      ...
      var viewableText = $("<div id='read-text'> ");
      // set it's html
