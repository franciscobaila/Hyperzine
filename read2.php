...
<body>
  ...
  <div id="read-text" contenteditable="true">
  ...
  if(isset($_POST['submit'])){
    ...
    if ((($_FILES["imgFile"]["type"] == "image/gif") || ($_FILES["imgFile"]["type"] == "image/jpeg") || ($_FILES["imgFile"]["type"] == "image/png")  || ($_FILES["imgFile"]["type"] == "image/pjpeg")) && ($_FILES["imgFile"]["size"] < 200000)){
      if(file_exists($_FILES["imgFile"]["name"])){
        ...
        <input style="color:white; background-color:red" type="button" value="Paste HTML" onclick="document.getElementById('read-text-editable').focus(); pasteHtmlAtCaret('<img src=' + 'uploads/<?php echo "$filename" ?> ' +'>'); ">
  <?php
    }
    } else {
      echo "invalid file.";
